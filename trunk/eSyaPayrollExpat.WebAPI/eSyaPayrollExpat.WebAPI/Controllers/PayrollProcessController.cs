...
namespace eSyaPayrollExpat.WebAPI.Controllers
{
    ...
    public class PayrollProcessController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<IActionResult> GetCurrencyExchangeRate(int businessKey, int payPeriod)
        {
            var rs = await _payrollProcessRepository.GetCurrencyExchangeRate(businessKey, payPeriod);
            return Ok(rs);
        }
        ...
        [HttpGet]
        public async Task<IActionResult> GetEmployeeForPayrollProcess_Redo(int businessKey, int payPeriod)
        {
            var rs = await _payrollProcessRepository.GetEmployeeForPayrollProcess_Redo(businessKey, payPeriod);
            return Ok(rs);
        }
        ...
        public async Task<IActionResult> GetAllSalaryEmployeeForPayPeriod(int businessKey, int payPeriod)
        {
            ...
            var processedEmployee = await _payrollProcessRepository.GetEmployeeForPayrollProcess_Redo(businessKey, payPeriod);
