...
using eSyaPayrollExpat.DL.Repository;
using eSyaPayrollExpat.IF;
using eSyaPayrollExpat.WebAPI.Extention;
using eSyaPayrollExpat.WebAPI.Utility;
...
namespace eSyaPayrollExpat.WebAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IPayrollProcessRepository, PayrollProcessRepository>();
